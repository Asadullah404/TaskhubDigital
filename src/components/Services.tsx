...
// ✅ Props type (matches Hero & index.tsx)
...
const services = [
  {
    ...
    description:
      "Custom websites, web apps, and responsive designs that captivate your audience.",
    icon: Globe,
  ...
  },
  {
    ...
    description:
      "Desktop applications, mobile apps, and enterprise solutions tailored to your needs.",
    icon: Code,
  ...
  },
  {
    ...
    description:
      "Boost your online visibility and drive organic traffic to your business.",
    icon: Search,
  ...
  },
  {
    ...
    features: ["Blog Posts", "Website Copy", "Social Media", "Technical Writing","Easy Writing" , "Presentation Making" ,"Article Writing"],
  },
  {
    id: "graphics-design",
    title: "Graphics & Design",
    description:
      "Visual identity, logos, and marketing materials that make your brand shine.",
    icon: Palette,
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`w-16 h-16 rounded-lg bg-gradient-to-r ${service.color} p-3 mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
        ...
        <div className="text-center mt-16">
          ...
          <button
            ...
            onClick={() => {
              const message =
                "Hello TaskHubDigital, I have a custom project requirement. Please guide me!";
